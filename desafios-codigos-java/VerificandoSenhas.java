...
public class VerificandoSenhas {
  ...
  public static String verificarForcaSenha(String senha) {
    ...
    boolean temTamanhoMinimo = senha.length() >= comprimentoMinimo;
    if (temLetraMaiuscula && temLetraMinuscula && temNumero && temCaractereEspecial && !temSequenciaComum
        && !temPalavraComum && temTamanhoMinimo) {
